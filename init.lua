...
vim.keymap.set('n', '<leader>l', '<Cmd>Lazy<CR>', { desc = 'Run [L]azy' })
vim.keymap.set('n', '<leader>gg', '<Cmd>LazyGit<CR>', { desc = 'Run Lazy[G]it' })
vim.keymap.set('n', '<leader>m', '<Cmd>Mason<CR>', { desc = 'Run [M]ason' })
...
vim.defer_fn(function()
  require('nvim-treesitter.configs').setup {
    ...
    ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'vim', 'bash' },
